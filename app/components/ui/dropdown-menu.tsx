...
function DropdownMenuItem({
    ...
    return (
        <DropdownMenuPrimitive.Item
            ...
            className={cn(
                // Меняем 'focus:bg-accent' на 'focus:bg-secondary' и убираем 'outline-hidden' (заменяем на 'outline-none')
...
function DropdownMenuCheckboxItem({
    ...
    return (
        <DropdownMenuPrimitive.CheckboxItem
            ...
            className={cn(
                "focus:bg-secondary relative flex cursor-default items-center gap-2 rounded-sm py-1.5 pr-2 pl-8 text-sm outline-none select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
                className
            )}
            checked={checked}
            {...props}
